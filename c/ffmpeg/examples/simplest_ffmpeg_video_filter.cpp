...
//gcc -o simplest_ffmpeg_video_filter.out simplest_ffmpeg_video_filter.cpp -fpermissive -lavfilter  -lpostproc -lavutil -lavformat -lavcodec  -lz -lavutil -lm -lpthread -lswresample -lswscale -lx264 -lx265  -llzma `sdl-config --cflags --libs`
