...
main(int argc, char *argv[])
{
	...
	/*
	 * we noted that SIGHUP is generated for the controlling process on 
	 * disconnection of a controlling terminal. Since a daemon has no 
	 * controlling terminal, the kernel never generates this signal for 
	 * a daemon. Therefore, daemons can use SIGHUP for the purpose described here.
	 * */
