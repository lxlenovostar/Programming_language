...
def pearson(v1,v2):
    ...
    # The final line of the code returns 1.0 minus the Pearson correlation to create 
    # a smaller distance between items that are more similar.
    return 1.0 - num/den
...
def kcluster(rows, distance = pearson, k = 4):
    ...
    # returned will almost always be different. 
    return bestmatches
