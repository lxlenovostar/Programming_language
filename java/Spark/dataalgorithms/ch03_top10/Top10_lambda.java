   ...
   public static void main(String[] args) throws Exception {
      ...
      * */
      ...
      for (SortedMap<Integer, String> localtop10 : alltop10) {
          ...
          * returned by the iterator, except through the setValue operation on the map entry.
          * */
      ...
      SortedMap<Integer, String> finaltop10 = partitions.reduce(
        new Function2<SortedMap<Integer, String>, // m1 (as input)
                      SortedMap<Integer, String>, // m2 (as input)
                      SortedMap<Integer, String> // output: merge of m1 and m2>() {
