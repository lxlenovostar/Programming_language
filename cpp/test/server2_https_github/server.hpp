...
private:
  ...
  void handle_accept_s(const boost::system::error_code& e);
  ...
  request_handler request_handler_;
	...
	//https
	boost::shared_ptr<tcp::acceptor> acceptor_s_;
	boost::shared_ptr<ssl::context> context_;
	connection_ptr_s_ new_connection_s_;
};
